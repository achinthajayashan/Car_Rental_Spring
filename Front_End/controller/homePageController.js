...
function loadCarDetails() {
    ...
    $.ajax({
        ...
        <div class="d-flex w-100 mt-5">
          <button class="btn w-50 bg-primary me-2 text-white"><i class="fa-solid fa-receipt me-2"></i>Book Now</button>
          <button class="btn w-50 bg-dark text-white"><i class="fa-solid fa-list me-2"></i>Add To List</button>
        </div>
